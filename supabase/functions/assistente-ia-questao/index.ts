...
INTEGRAÇÃO COM O SISTEMA — RESPOSTA JSON OBRIGATÓRIA:

Mantenha todas as regras pedagógicas deste prompt, mas nesta 
Edge Function a resposta final deve ser somente JSON válido, 
sem Markdown e sem rótulos textuais fora do JSON.

Use exatamente estas chaves, mesmo que algum valor fique vazio:
{
  "materia_sugerida": "",
  "assunto_sugerido": "",
  "banca_sugerida": "",
...
O campo "acao" corresponde ao rótulo AÇÃO CORRETIVA. Não use 
"acao_corretiva". Coloque nos campos JSON o conteúdo que, no 
fluxo textual, iria em PEGADINHAS, CONCEITO, RECONHECER e 
AÇÃO CORRETIVA.
