...
describe('prompt de flashcards da questao', () => {
  ...
  it('orienta flashcards autocontidos e independentes da questao original', () => {
    ...
    expect(prompt).toContain('a frase da questão')
    expect(prompt).toContain('letras de alternativas')
    expect(prompt).toContain('alternativa correta')
    expect(prompt).toContain('alternativa marcada')
    expect(prompt).toContain('o comentário e as pegadinhas abaixo podem mencionar alternativas por letra')
    expect(prompt).toContain('Ignore as letras')
    expect(prompt).toContain('extraia apenas conceitos, regras e armadilhas')
    ...
    expect(prompt).toContain('regra geral, conceito ou armadilha universal')
    expect(prompt).toContain('pode usar exemplo da questão apenas como ilustração')
    expect(prompt).toContain('Transforme alternativa, erro, trecho ou exemplo da questão em conceito universal')
