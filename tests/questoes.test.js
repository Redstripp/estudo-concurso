...
describe('prompt de flashcards da questao', () => {
  ...
  it('gera prompt com dados completos da questao e regras principais', () => {
    ...
    expect(prompt).toContain('Não invente lei, artigo, súmula, jurisprudência, doutrina ou')
  ...
  it('orienta flashcards autocontidos e independentes da questao original', () => {
    ...
    expect(prompt).toContain('sem exigir que o')
    ...
    expect(prompt).toContain('exemplos que só existem naquela questão')
    ...
    expect(prompt).toContain('extraia apenas conceitos, regras')
    expect(prompt).toContain('e armadilhas')
    ...
    expect(prompt).toContain('O exemplo pode ser retirado da questão')
    expect(prompt).toContain('Transforme alternativa, erro, trecho ou exemplo da questão')
    expect(prompt).toContain('em conceito universal')
    expect(prompt).toContain('padrão de cobrança generalizado')
    expect(prompt).toContain('armadilha genérica e')
